...
export default (variables /*: * */ = variable) => {
    const theme = {
        variables,
        "NativeBase.Left": Object.assign({}, leftTheme(variables)),
        "NativeBase.Right": Object.assign({}, rightTheme(variables)),
        "NativeBase.Body": Object.assign({}, bodyTheme(variables)),
        ...
        "NativeBase.PickerNB": Object.assign({}, pickerTheme(variables), { "NativeBase.Button": {
                "NativeBase.Text": {}
            } }),
        ...
        "NativeBase.Switch": Object.assign({}, switchTheme(variables)),
        "NativeBase.Separator": Object.assign({}, separatorTheme(variables)),
        "NativeBase.SwipeRow": Object.assign({}, swipeRowTheme(variables)),
        "NativeBase.Thumbnail": Object.assign({}, thumbnailTheme(variables))
    };
